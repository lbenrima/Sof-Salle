...
public class Members implements Serializable {
    ...
    @JsonIgnore
    private Grparticipants idgroup;
    ...
    public Members(Integer id, String name, String mail) {
        this.id = id;
        this.name = name;
        this.mail = mail;
    }
    ...
    public Grparticipants getIdgroup() {
        return idgroup;
    }

    public void setIdgroup(Grparticipants idgroup) {
    ...
    public String toString() {
        return "tn.sofrecom.mdrissi.entities.Members[ id=" + id + " ]";
    }
